...
| **Cursor** | **Composer** | Fase modelado: `ml/config.py`, `ml/data.py`, `ml/features.py`, `ml/evaluate.py`, `ml/train.py`, `ml/__main__.py`, `tests/test_ml.py`, `ml/README.md`. Entrenamiento comparativo regresión/clasificación; métricas en `ml/artifacts/training_metrics.json`. |
...
API, frontend e informe PDF (actualizar esta tabla al implementarlos).
